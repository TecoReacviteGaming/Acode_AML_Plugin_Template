...
After NDK is imported, move your shared library folder into Acode, first download this repository and extract **AcodeTemplate** folder then enter the following commands:
```bash
